...
public class ConvertBaseActivity extends Activity implements OnClickListener,OnMenuItemClickListener{
    //标识
    private int flag = 1;
    ...
    private void initView() {
        ...
        choose_one = findViewById(R.id.first_choose);
        choose_two = findViewById(R.id.second_choose);
        ...
        result_first.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                enabledButton(choose_one.getText().toString());
                flag = 1;
            }
        });
        result_second.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                enabledButton(choose_two.getText().toString());
                flag = -1;
            }
        });
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_F:
                ...
                if (flag == 1) {
                    ...
                    String sour_name = choose_one.getText().toString();
            ...
            case R.id.point:
                ...
                break;
            case R.id.first_choose:
                choose_length = 1;
                setDialog();
                break;
            case R.id.second_choose:
                choose_length = 2;
                setDialog();
                break;
            ...
            case R.id.btn_main_choose:
                //跳转到计算器页面
                Intent intent = new Intent(ConvertBaseActivity.this, MainActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.convert_exchange_rate:
                Intent intent_ex_ra = new Intent(ConvertBaseActivity.this, ConvertExchangeRateActivity.class);
            ...
            case R.id.convert_length:
                Intent intent_length = new Intent(ConvertBaseActivity.this,ConvertLengthActivity.class);
                startActivity(intent_length);
                break;
            case R.id.convert_area:
                Intent intent_area = new Intent(ConvertBaseActivity.this, ConvertAreaActivity.class);
                startActivity(intent_area);
                break;
            case R.id.convert_speed:
                Intent intent_speed = new Intent(ConvertBaseActivity.this, ConvertSpeedActivity.class);
                startActivity(intent_speed);
                break;
            case R.id.convert_temperature:
                Intent intent_tem = new Intent(ConvertBaseActivity.this, ConvertTemperatureActivity.class);
                startActivity(intent_tem);
                break;
            case R.id.convert_weight:
                Intent intent_wei = new Intent(ConvertBaseActivity.this, ConvertWeightActivity.class);
                startActivity(intent_wei);
                break;
            case R.id.convert_power:
                Intent intent_power= new Intent(ConvertBaseActivity.this, ConvertPowerActivity.class);
                startActivity(intent_power);
                break;
            case R.id.convert_pressure:
                Intent intent_pressure = new Intent(ConvertBaseActivity.this, ConvertPressureActivity.class);
                startActivity(intent_pressure);
                break;
            case R.id.convert_volume:
                Intent intent_volume = new Intent(ConvertBaseActivity.this, ConvertVolumeActivity.class);
    ...
    private void setDialog() {
        ...
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.bottom_dialog_base, null);

        //初始化视图
        root.findViewById(R.id.btn_bin).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                String button_text = ((Button) v).getText() + "";
                String text="";
                if(choose_length == 1)
                    choose_one.setText(button_text);
                else
                    choose_two.setText(button_text);
                if(flag == 1)
                    text = choose_one.getText().toString();
                else
                    text = choose_two.getText().toString();
                enabledButton(text);
        ...
        root.findViewById(R.id.btn_oct).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                String text = "";
        ...
        root.findViewById(R.id.btn_hex).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                String text = "";
        ...
        root.findViewById(R.id.btn_dec).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String button_text = ((Button) v).getText() + "";
                String text = "";
    ...
    public void enabledButton(String status){
        if("十六进制".equals(status)){
